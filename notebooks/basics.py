...
# iterate through a
for index, item in enumerate(a):    # enumerate function will generate an index for the item + item it self. 
print index, item 
...
0 a
1 b
...
lst = ['1', '2', '3']    # list of strings
str = ''.join(lst)

Or if the list is of integers, convert the elements before joining them.

lst2 = [1, 2, 3]    # list of integers
str1 = ''.join(str(e) for e in list1)     #convert integer to string before joining
...
str_eg1 = "this is string example....wow!!!";
str_eg2 = "exam";

# find function will print the position for the first character of the string if it's found!
print str_eg1.find(str_eg2);
print str_eg1.find(str_eg2, 10);
print str_eg1.find(str_eg2, 40);
